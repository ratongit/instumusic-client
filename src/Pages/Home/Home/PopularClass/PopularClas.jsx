...
const popularteacher=popular.slice(25, 34)

// console.log('this is popular ',  popularteacher)
    return (

        <div className="mb-5 mt-10">
      <h1 className="my-5 text-blue-500 text-center text-3xl font-semibold"> Popular Class </h1>
...

{
  popularteacher.map(data=>
    <div key={data._id}>
    <div className="flex justify-center lg:grid-cols-3 " >
...
<img src={data.teacherImg} className="w-[30px] h-[30px] rounded-3xl" alt="" />
