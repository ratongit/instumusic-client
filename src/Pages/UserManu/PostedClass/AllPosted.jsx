...
const AllPostedClass = () => {
    ...
    return (
        <div className="my-5 text-center">
            <h1 className="mb-3 text-blue-600 font-semibold text-center text-3xl">All Posted Class</h1>
            {
                post.map(data => <div key={data._id}>
